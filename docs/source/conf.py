...
BASE_DOC_DIR = os.path.abspath('..')
BASE_DIR = os.path.abspath(os.path.join(BASE_DOC_DIR, '..'))

sys.path.insert(0, BASE_DOC_DIR)
...
# documentation.
#
html_theme_options = {'github_user': 'alfred82santa',
                      'github_repo': 'telebot',
                      'github_banner': True,
                      'github_button': True,
                      'travis_button': True}
